      ...
      <div className="z-10 w-full grid md:grid-cols-[1.2fr_1fr] gap-12 items-center mb-24">
        ...
        >
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
            {/* Glowing Backdrop - Optimized */}
            <div className="absolute inset-0 bg-gradient-to-tr from-neon-purple/30 to-neon-blue/30 rounded-full blur-[30px]" />

            {/* Image Container - Optimized */}
            <motion.div
              className="relative w-full h-full rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-charcoal"
              whileHover={{ scale: 1.02 }}
              animate={{ y: [0, -5, 0] }}
              // @ts-ignore
              transition={{ repeat: Infinity, duration: 8, ease: "easeInOut", type: 'spring', stiffness: 300 }}
            >
