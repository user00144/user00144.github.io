...
import kguLogo from '../assets/imgs/logos/kgu-logo.png'; // 예: Kyonggi University 로고
import purdueLogo from '../assets/imgs/logos/purdue-logo.webp'; // 예: Purdue University 로고
...
// Now accepts an `imageUrl` prop for company logos
const ResumeItem = ({ title, subtitle, details, imageUrl }) => (
  <div className="flex items-start gap-4">
    ...
    {imageUrl && (
      <img 
        ...
        onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/48x48/e2e8f0/64748b?text=Logo'; }}
      />
    )}
      ...
      <div className="mt-12 space-y-12">
        ...
        <ResumeSection title="Education">
          <ResumeItem 
            ...
            // Example of adding a logo for an educational institution
            imageUrl={kguLogo}
          />
        </ResumeSection>
        ...
        <ResumeSection title="Experience">
          ...
          <ResumeItem 
            ...
            // TODO: Replace with actual Seoul National University logo URL
            imageUrl={snuLogo}
            details={
              <ul className="list-disc list-inside space-y-1">
        ...
        <ResumeItem 
            ...
            // TODO: Replace with actual ETRI logo URL
            imageUrl={etriLogo}
            details={
              <ul className="list-disc list-inside space-y-1">
          ...
          <ResumeItem 
            ...
            // TODO: Replace with actual LOTTE INNOVATE logo URL
            imageUrl={lotteLogo}
            details={
              <ul className="list-disc list-inside space-y-1">
          ...
          <ResumeItem 
            ...
            // TODO: Replace with actual Kyonggi University logo URL
            imageUrl={kguLogo}
            details={
              <ul className="list-disc list-inside space-y-1">
